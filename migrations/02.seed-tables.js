...
// notre premier livre
const book = await Book.create({ title: "Le livre sans nom", release_date: "2010-06-03", cover: "https://covers.openlibrary.org/b/isbn/0751538698-L.jpg", synopsis: "Santa Mondega, une ville d’Amérique du Sud oubliée du reste du monde, où sommeillent de terribles secrets... Un mystérieux tueur en série, qui assassine ceux qui ont eu la malchance de lire un énigmatique ‘livre sans nom’... La seule victime encore vivante du tueur, qui, après cinq ans de coma, se réveille, amnésique... Deux flics très spéciaux, un tueur à gages sosie d’Elvis Presley, des barons du crime, des moines férus d’arts martiaux, une pierre précieuse à la valeur inestimable, un massacre dans un monastère isolé, quelques clins d’œil à Seven et à The Ring... et voilà le thriller le plus rock’n’roll et le plus jubilatoire de l’année !", });
const book2 = await Book.create({ title: "Orgueil et Préjugés", release_date: "1813-01-28", cover: "https://covers.openlibrary.org/b/isbn/9780141439518-L.jpg", synopsis: "Une romance classique sur les mœurs et les préjugés dans l’Angleterre du XIXe siècle." });
const book3 = await Book.create({ title: "Wild", release_date: "2012-03-20", cover: "https://covers.openlibrary.org/b/isbn/9780307592736-L.jpg", synopsis: "Le récit autobiographique de Cheryl Strayed, une randonnée de 1700 km pour se reconstruire." });
const book4 = await Book.create({ title: "Veiller sur elle", release_date: "2023-01-05", cover: "https://placehold.co/300x450/8B4513/ffffff?text=Veiller+sur+elle", synopsis: "Un roman poignant sur la mémoire, la guerre et la résilience." });
const book5 = await Book.create({ title: "Rendez-vous avec le crime", release_date: "2014-06-12", cover: "https://placehold.co/300x450/2F4F4F/ffffff?text=Rendez-vous+avec+le+crime", synopsis: "Une enquête cosy dans un village anglais menée par une bibliothécaire curieuse." });
const book6 = await Book.create({ title: "Paradise Kiss", release_date: "2000-01-01", cover: "https://covers.openlibrary.org/b/isbn/9781591164951-L.jpg", synopsis: "Un manga sur la mode, l’amour et la quête de soi dans le Tokyo branché." });
const book7 = await Book.create({ title: "NANA", release_date: "2000-05-26", cover: "https://covers.openlibrary.org/b/isbn/9781591169703-L.jpg", synopsis: "Deux jeunes femmes nommées Nana, liées par le destin et les émotions dans un Tokyo vibrant." });
const book8 = await Book.create({ title: "Les Optimistes", release_date: "2019-02-07", cover: "https://placehold.co/300x450/4682B4/ffffff?text=Les+Optimistes", synopsis: "Un roman sur la mémoire, la musique et les liens familiaux à travers les générations." });
const book9 = await Book.create({ title: "Le Sympathisant", release_date: "2015-04-02", cover: "https://covers.openlibrary.org/b/isbn/9780802123459-L.jpg", synopsis: "Un espion vietnamien infiltré dans la communauté exilée aux États-Unis après la guerre." });
const book10 = await Book.create({ title: "Le journal de Mr Darcy", release_date: "2007-09-15", cover: "https://covers.openlibrary.org/b/isbn/9780425212875-L.jpg", synopsis: "Une réécriture intime du classique de Jane Austen, vue par Darcy lui-même." });
const book11 = await Book.create({ title: "La petite confiserie de l’allée nocturne", release_date: "2021-11-10", cover: "https://placehold.co/300x450/9B59B6/ffffff?text=La+petite+confiserie", synopsis: "Un conte sucré et mystérieux dans une ruelle magique où les souvenirs prennent goût." });
const book12 = await Book.create({ title: "Impardonnable", release_date: "2015-03-12", cover: "https://placehold.co/300x450/1C1C1C/ffffff?text=Impardonnable", synopsis: "Un roman noir sur la culpabilité, le silence et les conséquences irréversibles." });
const book13 = await Book.create({ title: "Golden Kamui Tome 1", release_date: "2014-08-01", cover: "https://covers.openlibrary.org/b/isbn/9781974703760-L.jpg", synopsis: "Un manga d’aventure historique sur la chasse au trésor dans le Japon de l’ère Meiji." });
const book14 = await Book.create({ title: "Ernestine", release_date: "2022-09-22", cover: "https://placehold.co/300x450/E74C3C/ffffff?text=Ernestine", synopsis: "Une héroïne singulière dans un roman tendre et drôle sur la solitude et la liberté." });
const book15 = await Book.create({ title: "Les Sept Sœurs", release_date: "2014-12-01", cover: "https://placehold.co/300x450/1A5276/ffffff?text=Les+Sept+Soeurs", synopsis: "Une saga familiale inspirée des constellations, pleine de mystère et de voyages." });
const book16 = await Book.create({ title: "La Servante Écarlate", release_date: "1985-09-01", cover: "https://covers.openlibrary.org/b/isbn/9782070367061-L.jpg", synopsis: "Un roman dystopique sur la domination patriarcale et la résistance féminine." });
const book17 = await Book.create({ title: "Druss la Légende", release_date: "1993-06-01", cover: "https://placehold.co/300x450/5D6D7E/ffffff?text=Druss+la+Legende", synopsis: "Une épopée fantasy sur un guerrier mythique, entre honneur, combat et solitude." });
const book18 = await Book.create({ title: "Endymion", release_date: "1996-02-01", cover: "https://covers.openlibrary.org/b/isbn/9780553572940-L.jpg", synopsis: "Une aventure de science-fiction dans l’univers d’Hyperion, entre poésie et technologie." });
const book19 = await Book.create({ title: "Le Seigneur des Anneaux", release_date: "1954-07-29", cover: "https://covers.openlibrary.org/b/isbn/9780618640157-L.jpg", synopsis: "La quête épique de l’Anneau unique dans un monde fantastique peuplé de héros et de ténèbres." });
const book20 = await Book.create({ title: "Conan le cimmérien", release_date: "1932-01-01", cover: "https://placehold.co/300x450/7D6608/ffffff?text=Conan+le+Cimmerien", synopsis: "Les aventures brutales et mythiques du barbare Conan dans un monde sauvage et magique." });
