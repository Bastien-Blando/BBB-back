...
const book2 = await Book.create({ title: "Orgueil et Préjugés", release_date: "1813-01-28", cover: "https://covers.openlibrary.org/b/isbn/9782290375983-L.jpg", synopsis: "Une romance classique sur les mœurs et les préjugés dans l’Angleterre du XIXe siècle." });
...
const book4 = await Book.create({ title: "Veiller sur elle", release_date: "2023-01-05", cover: "https://covers.openlibrary.org/b/isbn/9782226471154-L.jpg", synopsis: "Un roman poignant sur la mémoire, la guerre et la résilience." });
const book5 = await Book.create({ title: "Rendez-vous avec le crime", release_date: "2014-06-12", cover: "https://covers.openlibrary.org/b/isbn/9782702160060-L.jpg", synopsis: "Une enquête cosy dans un village anglais menée par une bibliothécaire curieuse." });
...
const book8 = await Book.create({ title: "Les Optimistes", release_date: "2019-02-07", cover: "https://covers.openlibrary.org/b/isbn/9781432862725-L.jpg", synopsis: "Un roman sur la mémoire, la musique et les liens familiaux à travers les générations." });
...
const book11 = await Book.create({ title: "La petite confiserie de l’allée nocturne", release_date: "2021-11-10", cover: "https://covers.openlibrary.org/b/isbn/9782823874167-L.jpg", synopsis: "Un conte sucré et mystérieux dans une ruelle magique où les souvenirs prennent goût." });
const book12 = await Book.create({ title: "Impardonnable", release_date: "2015-03-12", cover: "https://covers.openlibrary.org/b/isbn/9782246864684-L.jpg", synopsis: "Un roman noir sur la culpabilité, le silence et les conséquences irréversibles." });
...
const book14 = await Book.create({ title: "Ernestine", release_date: "2022-09-22", cover: "https://covers.openlibrary.org/b/isbn/9782021507577-L.jpg", synopsis: "Une héroïne singulière dans un roman tendre et drôle sur la solitude et la liberté." });
const book15 = await Book.create({ title: "Les Sept Sœurs", release_date: "2014-12-01", cover: "https://covers.openlibrary.org/b/isbn/9782823870466-L.jpg", synopsis: "Une saga familiale inspirée des constellations, pleine de mystère et de voyages." });
...
const book17 = await Book.create({ title: "Druss la Légende", release_date: "1993-06-01", cover: "https://covers.openlibrary.org/b/isbn/9781857236453-L.jpg", synopsis: "Une épopée fantasy sur un guerrier mythique, entre honneur, combat et solitude." });
...
const book20 = await Book.create({ title: "Conan le cimmérien", release_date: "1932-01-01", cover: "https://covers.openlibrary.org/b/isbn/9782823874167-L.jpg", synopsis: "Les aventures brutales et mythiques du barbare Conan dans un monde sauvage et magique." });
